...
return view.extend({
    ...
    render: function () {
        ...
        var htmlTemplate = [
            ...
            '.nw-actions .cbi-button-apply { background: #10b981 !important; color: white !important; transition: all 0.25s ease !important; }',
            ...
            '.nw-actions .cbi-button-reset { background: #f43f5e !important; color: #fff !important; transition: all 0.25s ease !important; }',
            '.nw-actions .cbi-button-reset:hover { background: #e11d48 !important; transform: translateY(-2px) !important; box-shadow: 0 6px 15px rgba(244, 63, 94, 0.35) !important; }','.nw-radio-group { display: flex; gap: 24px; font-size: 15px; color: #333; align-items: center; margin: 0; padding: 0; }',
